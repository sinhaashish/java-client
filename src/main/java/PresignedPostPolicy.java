...
public class PresignedPostPolicy {
  ...
  public static void main(String[] args)
    ...
    try {
      ...
      PostPolicy policy = new PostPolicy("testbucket", "my-objectname", DateTime.now().plusDays(7));
      // 'my-objectname' should be 'image/png' content type
      policy.setContentType("image/png");
      policy.setSuccessActionStatus(205);
      ...
      System.out.println(" -F file=/home/ashish/Pictures/test.png https://play.min.io:9000/testbucket");
